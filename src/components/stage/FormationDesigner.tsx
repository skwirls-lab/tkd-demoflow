    ...
    <div className="flex flex-col gap-4 h-full w-full">
      ...
      <div className="w-full relative aspect-[3/1] bg-[#0a0a0a] rounded-xl md:rounded-3xl border-2 md:border-4 border-belt-gray/40 overflow-hidden shadow-2xl cursor-crosshair select-none"
        ...
        >
          ...
          <div className="absolute top-3 md:top-6 left-1/2 -translate-x-1/2 px-4 md:px-10 py-1 md:py-2.5 bg-belt-red text-[8px] md:text-[11px] font-black text-white uppercase tracking-[0.3em] md:tracking-[0.5em] rounded-full z-20 italic ring-2 md:ring-4 ring-belt-red/10">
            Front
          </div>
            ...
            return (
              <div
                ...
                style={{ 
                  left: `${pos.x}%`, 
                  top: `${pos.y}%`,
                  width: '3.5%', // Dot size is relative to mat width
                  aspectRatio: '1/1'
                }}
              >
                {/* Node */}
